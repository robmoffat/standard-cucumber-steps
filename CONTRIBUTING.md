# Cucumber Testing Steps Contribution and Governance Policies

This document describes the contribution process and governance policies of the FINOS Cucumber Testing Steps project (a software repository under the [FDC3](https://github.com/finos/FDC3) project). The project is also governed by the [Linux Foundation Antitrust Policy](https://www.linuxfoundation.org/antitrust-policy/), and the FINOS [IP Policy](https://community.finos.org/governance-docs/IP-policy.pdf), [Code of Conduct](https://community.finos.org/docs/governance/code-of-conduct), [Collaborative Principles](https://community.finos.org/docs/governance/collaborative-principles/), and [Meeting Procedures](https://community.finos.org/docs/governance/meeting-procedures/).

## Technical Charter

Cucumber Testing Steps is intended to live under the FDC3 project. Until FINOS publishes a dedicated Technical Charter PDF at the root of this repository, charter-level governance (mission, TSC, IP and licensing) follows the parent [FDC3](https://github.com/finos/FDC3) project. Do not duplicate that material here.

For structure and wording of FINOS software project charters, see this **[example Technical Charter (finos/5-spot)](https://github.com/finos/5-spot/blob/main/technical-charter.pdf)**.
...
Definitions of **Contributor**, **Maintainer**, **Lead Maintainer**, TSC responsibilities, and charter-level voting follow FINOS software project norms and the parent FDC3 project. The current Maintainer roster is listed in **[MAINTAINERS.md](./MAINTAINERS.md)**.
